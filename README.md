...
* Alternatively, the app/website is published and can be accessed in below link:                 
[coral_bleaching_shinyapp](https://vpatil.shinyapps.io/coral_bleaching_great_barrier_reef)
